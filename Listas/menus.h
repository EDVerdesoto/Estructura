...
int desplegar_menu_principal(){
    const int NUM_OPCIONES = 10;
    const char* OPCIONES[NUM_OPCIONES] = {"Insertar elementos a la lista por la cola",
    "Imprimir elementos de la lista","Eliminar elemento de la lista",
    "Insertar entre elementos de la lista",
    "Invertir pares lista",
    "Imprimir lista invertida pares",
    "Ordenar impares", "Insertar tabla hash", "Ordenamiento burbuja", "Salir"};
    int opcion;
    visibilidad_cursor(false);
